[cybersecuritywithprivategpt-28fb] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-28fb] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-28fb] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/carterd132/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35005  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='carterd132'  \-\-env DOCKERUSERNAME='carterd132@gmail.com'  \-\-env MQTTUSERNAME='yedgy'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   carterd132@gmail.com/cybersecuritywithprivategpt-28fb-amd64 (https://hub.docker.com/r/carterd132@gmail.com/cybersecuritywithprivategpt-28fb-amd64)
...
.. code-block::
   ...
   docker run -d -p 47501:47501 -p 53035:53035 -p 37959:37959 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=cybersecuritywithprivategpt-28fb \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-28fb \
          --env GITUSERNAME=carterd132 \
          --env GITREPOURL=https://github.com/carterd132/raspberrypi \
          --env SOLUTIONEXTERNALPORT=47501 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=53035  \
          --env SOLUTIONVIPERVIZPORT=37959 \
          --env DOCKERUSERNAME='carterd132@gmail.com' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=35005 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='yedgy' \
          --env AIRFLOWPORT=9000  \
          --env GITPASSWORD='<Enter Github Password>' \
          --env KAFKACLOUDPASSWORD='<Enter API secret>' \
          --env MQTTPASSWORD='<Enter mqtt password>' \
          --env READTHEDOCS='<Enter Readthedocs token>' \
          carterd132@gmail.com/cybersecuritywithprivategpt-28fb-amd64
...
[cybersecuritywithprivategpt-28fb] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/carterd132/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-28fb
...
.. important::
   https://cybersecuritywithprivategpt-28fb.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-28fb
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=47501, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=36313, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45561, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36639, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44015, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45311, HPDEHOST=127.0.1.1, HPDEPORT=43981, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34625

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9965-cybersecuritywithprivategpt-28fb,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-28fb, python-preprocess-6869-cybersecuritywithprivategpt-28fb,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-28fb, python-ai-6970-cybersecuritywithprivategpt-28fb,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-28fb, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
